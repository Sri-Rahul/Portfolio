...
// Custom hook to run an effect only once
...
const useEventListener = (
  ...
  useEffect(() => {
    window.addEventListener(eventName, savedHandler);
    return () => {
      window.removeEventListener(eventName, savedHandler);
    };
  }, [eventName, savedHandler]);
};
